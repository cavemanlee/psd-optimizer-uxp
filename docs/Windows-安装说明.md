# PSD Optimizer 1.7.5 — Windows 安装说明

安装文件：`PSD-Optimizer-1.7.5-Windows-x64.exe`
...
1. 双击 `PSD-Optimizer-1.7.5-Windows-x64.exe`。
...
```powershell
Get-FileHash .\PSD-Optimizer-1.7.5-Windows-x64.exe -Algorithm SHA256
```
