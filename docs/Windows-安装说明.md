# PSD Optimizer 1.8.0 — Windows 安装说明

安装文件：`PSD-Optimizer-1.8.0-Windows-x64.exe`
...
1. 双击 `PSD-Optimizer-1.8.0-Windows-x64.exe`。
...
```powershell
Get-FileHash .\PSD-Optimizer-1.8.0-Windows-x64.exe -Algorithm SHA256
```
